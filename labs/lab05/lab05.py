...
def closer_city(lat, lon, city1, city2):
    ...
    return get_name(city1) if distance(new_city, city1) < distance(new_city, city2) else get_name(city2)
...
def nut_finder(t):
    ...
    if is_leaf(t):
        ...
        return any([nut_finder(branch) for branch in branches(t)])
